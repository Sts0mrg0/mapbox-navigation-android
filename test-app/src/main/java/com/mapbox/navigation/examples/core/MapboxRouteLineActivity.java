...
public class MapboxRouteLineActivity extends AppCompatActivity implements OnMapLongClickListener {
      ...
      public void onClick(View view) {
        ...
        mapboxMap.loadStyleUri(style, new Style.OnStyleLoaded() {
          ...
          public void onStyleLoaded(@NotNull Style style) {
            Expected<LayerVisibilityUpdate, RouteLineError> primaryRouteVisibilityState;
            ...
            mapboxRouteLineView.renderVisibilityUpdate(style, primaryRouteVisibilityState);

            Expected<LayerVisibilityUpdate, RouteLineError> alternateRouteVisibilityState;
            ...
            mapboxRouteLineView.renderVisibilityUpdate(style, alternateRouteVisibilityState);
  ...
  private OnIndicatorPositionChangedListener onIndicatorPositionChangedListener = point -> {
    Expected<VanishingRouteLineUpdateValue, RouteLineNoUpdate> vanishingRouteLineData = mapboxRouteLineApi.updateTraveledRouteLine(point);
